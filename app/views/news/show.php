<div class="card w-50">
        ...
        if (!empty($notes)) {
            foreach ($notes as $value => $note) {
                ...
                echo'&nbsp;';
                echo '<a href="index.php?controller=news&action=update" class="btn btn-primary">Обновить</a>';
                echo'&nbsp;';
                echo '<a href="index.php?controller=news&action=delete" class="btn btn-danger">Удалить</a>';
                echo '</div>';
            }
        } else {
            echo '<div class="card-header">';
